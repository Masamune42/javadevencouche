...
public class Tests {
	...
	public static void main(String[] args) {
		...
		Personne p = null;
		/************************* Votre code : ****************************/
		p = new Personne("Mansoif", "Gérard", 33);
		...
		System.out.println("\nDrill 2 : ");
		/************************* Votre code : ****************************/
		System.out.printf("Prénom : %s, Nom : %s", p.getPrenom(), p.getNom());
		/*********************************************************************/
		...
		// Votre r�ponse : Affectve p à un objet null (vide)
		...
		/*************************  Votre code :  ****************************/ 
		charlotteHornets.supprimerJoueur("ZELLER", "Cody");
		/*********************************************************************/
		charlotteHornets.afficherEquipe();
