...
import fr.eni.papeterie.dal.jdbc.ArticleDAOJdbcImplPostgres;

public class AppliTestDALPSQL {

	public static void main(String[] args) {

		//Déclaration et instanciation de la DAO
		ArticleDAOJdbcImplPostgres articleDAO = new ArticleDAOJdbcImplPostgres();
